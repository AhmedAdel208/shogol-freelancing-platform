...
export default function ClientInfo({
  ...
  return (
    <div className="bg-[#ffffff] rounded-3xl transition-all duration-400 ease-out shadow-[0_2px_10px_rgb(0,0,0,0.03)] border border-gray-100/80 overflow-hidden relative group">
      ...
      <div className="p-7">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          ...
          <div className="relative group/avatar">
            ...
            <div className="w-25.5 h-25.5 relative bg-white rounded-full flex items-center justify-center shrink-0 ring-[5px] ring-primary/10 shadow-2xl shadow-primary/10 group-hover/avatar:shadow-primary/30 transition-all duration-500 z-10 overflow-hidden">
        ...
        <button
          ...
          className="group/btn relative w-full overflow-hidden rounded-2xl font-bold font-cairo text-base transition-all duration-400 active:scale-[0.98] shadow-md shadow-slate-200/50 hover:shadow-lg hover:shadow-primary/20 cursor-pointer"
        >
          {/* Base Layer */}
          ...
          <div className="relative flex items-center justify-center gap-3 py-3.5 px-6 transition-colors duration-500 text-slate-600 group-hover/btn:text-white">
            <MessageSquareMore
              size={20}
              strokeWidth={2.5}
              className="group-hover/btn:-translate-y-0.5 group-hover/btn:rotate-6 transition-transform duration-300"
            />
