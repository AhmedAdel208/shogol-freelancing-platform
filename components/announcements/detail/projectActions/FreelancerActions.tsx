...
export default function FreelancerActions({
  ...
  const scrollToForm = () => {
    ...
    if (section) {
      ...
      section.classList.add("ring-8", "ring-primary/10", "shadow-[0_0_80px_rgba(28,178,185,0.2)]");
      setTimeout(() => {
        section.classList.remove("ring-8", "ring-primary/10", "shadow-[0_0_80px_rgba(28,178,185,0.2)]");
      }, 2000);
    }
  };
